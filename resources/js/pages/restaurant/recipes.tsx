...
function RecipeMetadataForm({ recipe }: { recipe: Recipe }) {
    ...
    return (
        <form onSubmit={submit} className="grid gap-3 border-b border-border/60 p-4 transition-colors hover:bg-muted/50 md:grid-cols-[120px_1.4fr_1fr_1fr_auto] md:items-start">
            <div className="grid gap-1">
                <label className="text-xs font-medium uppercase text-muted-foreground">Codigo</label>
            ...
            <div className="grid gap-1">
                <label className="text-xs font-medium uppercase text-muted-foreground">Plato</label>
            ...
            <div className="grid gap-1">
                <label className="text-xs font-medium uppercase text-muted-foreground">Subcategoria</label>
...
function RecipeItemForm({ item }: { item: RecipeItem }) {
    ...
    return (
        <form
            onSubmit={submit}
            className="grid gap-3 border-t border-border/60 px-4 py-3 transition-colors hover:bg-muted/50 md:grid-cols-[56px_1.4fr_120px_130px_1fr_auto] md:items-start"
        >
            <span className="flex h-10 items-center text-sm font-medium text-muted-foreground">#{item.sort_order}</span>
            <div className="grid gap-1">
                <Input
    ...
    return (
        <Card className="border-border/60 bg-card shadow-none transition-colors duration-150 hover:border-border">
            <CardHeader className="gap-3 p-5">
                <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                    <div className="min-w-0">
                        ...
                        <CardTitle className="mt-3 text-base font-semibold text-foreground">{recipe.dish_name}</CardTitle>
                    </div>
            ...
            <CardContent className="p-0">
                ...
                <div className="hidden border-t border-border/60 bg-muted/40 px-4 py-2 text-xs font-medium uppercase text-muted-foreground md:grid md:grid-cols-[56px_1.4fr_120px_130px_1fr_auto]">
                    <span>Linea</span>
                ...
                <section className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
                        <div className="grid gap-2">
                            <h1 className="text-2xl font-semibold text-foreground">Receta minima estandar</h1>
